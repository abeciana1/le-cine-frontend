            ...
            <MediaQuery maxWidth={999}>
              <div style={{ marginLeft: "20px", marginRight: "20px" }}>
                ...
                <div className="home-page-textbody" style={{ width: "100%" }}>
                  Join the fun every week with 2 films! A discussion film where
                  we feel the feels together and analyze the heck out of it. A
                  watch-along film where we can sit back, relax, and enjoy.
                  Drink up and smoke 'em if you got 'em!
                </div>
                <br />
                <Link to="/about">
                ...
                {/* <div className="join"> */}
                  ...
                  > */}
                    ...
                    <div className="start-club" style={{ width: "50%" }}>
                        Head over to the <a href="/pandemic-film-club">Pandemic Film Club</a> page to signup
                        for SMS notifications and be in-the-know each week
                    </div> */}
                    {/* 
                        <br />
                        <br /> */}
