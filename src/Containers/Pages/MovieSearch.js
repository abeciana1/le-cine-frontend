        ...
        return(
            <React.Fragment>
                <div style={{"marginLeft": "50px", "marginTop": "50px", "marginRight": "50px"}}>
                    ...
                    {this.state.searchResults ? <MovieSearchResults watchlistHandler={this.props.watchlistHandler} movieShow={this.props.movieShow} searchResults={this.state.searchResults} user={this.props.user} /> : null }
                </div>
            </React.Fragment>
        )
    }
