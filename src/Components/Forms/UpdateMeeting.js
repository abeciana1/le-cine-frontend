            ...
            <React.Fragment>
                <Form onSubmit={this.updateHandler}>
                    <Form.Group controlId="meetingTitle">
                        ...
                        <Form.Control required type="text" name="title" value={this.state.title} onChange={this.changeHandler} placeholder="Meeting Title" />
                    </Form.Group>
                    <Form.Group controlId="meetingExcerpt">
                        <Form.Label>If you have an excerpt for your meeting, please provide one:</Form.Label>
                        <Form.Control required type="text" name="excerpt" value={this.state.excerpt} onChange={this.changeHandler} placeholder="Meeting Excerpt"/>
                    </Form.Group>
                    ...
                    <Form.Group controlId="meetingDate">
                        ...
                        <Form.Control required type="date" name="date" value={this.state.date} onChange={this.changeHandler} />
                    </Form.Group>
                    <Form.Group controlId="meetingTime">
                        <Form.Label>Choose the time of your meeting:</Form.Label>
                        <Form.Control required type="time" name="time" value={this.state.time} onChange={this.changeHandler} />
                    </Form.Group>
                    <Form.Group controlId="meetingLink">
                        <Form.Label>Please provide a meeting link:</Form.Label>
                        <Form.Control required type="text" name="link" value={this.state.link} onChange={this.changeHandler} placeholder="Meeting Link" />
                    </Form.Group>
